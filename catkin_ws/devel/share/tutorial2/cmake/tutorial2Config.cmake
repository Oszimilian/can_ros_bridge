...
if("TRUE" STREQUAL "TRUE")
  set(tutorial2_SOURCE_PREFIX /VsRosTest/catkin_ws/src/tutorial2)
  set(tutorial2_DEVEL_PREFIX /VsRosTest/catkin_ws/devel)
  ...
  set(tutorial2_INSTALL_PREFIX /VsRosTest/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tutorial2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/VsRosTest/catkin_ws/src/tutorial2/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tutorial2_EXPORTED_TARGETS ${${tutorial2_dep}_EXPORTED_TARGETS})
endforeach()
